...
from notix import Notix, WebhookVerificationError  # type: ignore[import-not-found]


WEBHOOK_SECRET = os.getenv("NOTIX_WEBHOOK_SECRET", "whsec_test")

app = Flask(__name__)
notix = Notix("notix_test")
webhooks = notix.webhooks(WEBHOOK_SECRET)
