"""Webhook verification and event construction for Notix webhooks.
...
WEBHOOK_SIGNATURE_HEADER = "X-Notix-Signature"
WEBHOOK_TIMESTAMP_HEADER = "X-Notix-Timestamp"
WEBHOOK_EVENT_HEADER = "X-Notix-Event"
WEBHOOK_CALL_HEADER = "X-Notix-Call"
